...
build_spout(Workers, SpoutId, {Module, Args} = Spout, ChildSpecs) ->
  ...
  NewSpec = {ChildId, {spout_server, start_link, [ChildId, {Module, Args}, topology_event_manager]}, permanent, brutal_kill, worker, [spout_server]},
...
build_bolt(Workers, BoltId, {Module, Args} = Bolt, ChildSpecs) ->
  ...
  NewSpec = {ChildId, {bolt_server, start_link, [ChildId, {Module, Args}]}, permanent, brutal_kill, worker, [bolt_server]},
